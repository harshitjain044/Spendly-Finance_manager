...
const SignUp = () => {
  ...
  return (
    <div className="relative min-h-svh overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(20,184,166,0.18),_transparent_30%),linear-gradient(180deg,_rgba(248,250,252,0.96),_rgba(236,253,245,0.84))] px-4 py-6 dark:bg-[radial-gradient(circle_at_top,_rgba(45,212,191,0.16),_transparent_28%),linear-gradient(180deg,_rgba(2,6,23,1),_rgba(15,23,42,0.96))] sm:px-6 lg:px-8">
      <div className="absolute inset-x-0 top-0 h-72 bg-[radial-gradient(circle_at_center,_rgba(45,212,191,0.14),_transparent_70%)]" />
      <div className="absolute left-[10%] top-28 hidden size-64 rounded-full bg-teal-400/10 blur-3xl lg:block" />
      <div className="absolute bottom-16 right-[8%] hidden size-72 rounded-full bg-emerald-400/10 blur-3xl lg:block" />
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    Build your account to start spotting patterns from day one.
                  </p>
                </div>
              </div>
            </div>
